...
- (void)setWordcountLable:(NSNumber *)limitLength {
     ...
     *  字数限制
     */
    self.wordCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.frame)-30, CGRectGetWidth(self.frame) - 10, 20)];
...
- (void)layoutSubviews {
    ...
    if (self.limitLength && self.wordCountLabel) {
         ...
         */
        self.wordCountLabel.frame = CGRectMake(0, CGRectGetHeight(self.frame) - 30 + self.contentOffset.y, CGRectGetWidth(self.frame) - 10, 20);
    }
